...
const imgSource = "https://apileap.com/api/screenshot/v1/urltoimage?access_key=6597e3c2daf5432cb84991dbd18c09f8&url=";
...
//            })
    ...
    openBrowser = (url) => {
    //var link = JSON.stringify(obj.url);
...
//    if(this.state.clickedValue.length >=6){
//        this.state.
        ...
        <Image
          ...
          <Text
            style={styles.homeButText}
                 > { ((this.state.clickedValue).length > this.state.maxLimit) ? 
    (((this.state.clickedValue).substring(0,this.state.maxLimit-3)) + '...') : 
