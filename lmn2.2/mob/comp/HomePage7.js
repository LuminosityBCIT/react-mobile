     ...
     <View style={styles.titlePart3}>                         
        ...
        source={require('../imgs/bg_bar.png')}
         style={[styles.sidediv, {left: this.state.sideDivl}]} >
                  ...
                  activeOpacity={1}>
                        <Image
                            source={require('../imgs/clicktoEdit.png')}
              ...
              <View style={[styles.sidedivPart3, {height: this.state.sideP3H}]}>  
                 <Image
                            source={require('../imgs/editZone.png')}
                            style={styles.sidedivPart3Img}/> 
             </View> 

             <View style={[styles.sidedivPart4, {height: this.state.sideP4H}]}>  
                  <Image
                            source={require('../imgs/removeZone.png')}
